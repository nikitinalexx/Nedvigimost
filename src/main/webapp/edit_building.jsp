    ...
    <div class="col-sm-6">
        <div class="jumbotron">
            ...
            <form>
                ...
                <div class="form-group">
                    <label for="email_owner">Email власника</label>
                    <input type="email" class="form-control" id="email_owner" placeholder="Email власника">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Виберіть тип дії <span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu">
                            <li><a href="#">Будинок</a></li>
                            <li><a href="#">Квартира</a></li>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="notes">Замітки</label>
                                    <input type="text" class="form-control" id="notes" placeholder="Замітки">
                                </div>



                                <br /><button type="submit" class="btn btn-default">Зберегти</button>
            </form>
        </div>
    </div>
</div> <!-- /container -->
